 ...
 * @author JRD Systems
 * 
 *         WebChromeClient for browser tests. Wraps around existing client so
 *         that specific methods can be overridden if needed.
 * 
 */
public class CustomWebChromeClient extends WebChromeClient {
	...
	public CustomWebChromeClient(WebChromeClient wrappedClient) {
	...
	public void openFileChooser(ValueCallback<Uri> uploadFile) {
		((CustomWebChromeClient) mWrappedClient).openFileChooser(uploadFile);
	}
}
